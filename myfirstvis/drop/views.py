...
# #     #[("海门", 9), ("鄂尔多斯", 12), ("大庆", 279)]
# #     cmap = (
# #         Map(init_opts=opts.InitOpts(width="550px", height="400px", theme=ThemeType.CHALK))
...
# #             visualmap_opts=opts.VisualMapOpts(max_=max_count, textstyle_opts=opts.TextStyleOpts(color='#fff')),#max_=max_count,
